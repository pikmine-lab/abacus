  ...
  server.registerTool(
    'confirm_levy_payment',
    {
      ...
      inputSchema: z.object({
        ...
        account: z.string().describe("The account it left, one of the activity's own"),
